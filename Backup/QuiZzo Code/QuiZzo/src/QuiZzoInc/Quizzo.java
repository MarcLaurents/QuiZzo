...
public class Quizzo implements ActionListener {
	...
	public void menuDevs() {
		...
		devNome0.setText("     Marcelo Laurentino Costa Melo" + "\n     RA: 321220650");
	...
	public void partida() {
		...
		textfield.setBounds(0, 0, 1000, 50); // DEFINE A AREA DO TEXTO DO NUMERO DA QUESTÃO
		textfield.setBackground(new Color(164, 229, 224)); // SETTA COR DO PLANO DE FUNDO DO NUMERO DA QUESTAO
		textfield.setForeground(new Color(12, 97, 112)); // SETTA COR DO TEXTO DO NUMERO DA QUESTAO
		textfield.setFont(new Font("Comic Sans MS", Font.BOLD, 20)); // SETTA TIPO DE FONTE E TAMANHO DO NUMERO DA QUESTAO
		textfield.setBorder(BorderFactory.createBevelBorder(1));
		textfield.setHorizontalAlignment(JTextField.CENTER); // SETTA ALINHAMENTO DO TEXTO DO NUMERO DA QUESTAO
		textfield.setEditable(false); // SETTA COMO INALTERAVEL O TEXTO DO NUMERO DA QUESTAO

		areaQuestao.setBounds(0, 50, 1000, 50);
		areaQuestao.setLineWrap(true);
		areaQuestao.setWrapStyleWord(true);
		areaQuestao.setBackground(new Color(164, 229, 224));
		areaQuestao.setForeground(new Color(12, 97, 112));
		areaQuestao.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		...
		bRespostaA.setFont(new Font("Comic Sans MS", Font.BOLD, 20)); // SETTING FONT TYPE
		...
		bRespostaB.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		bRespostaB.setFocusable(false);
		bRespostaB.addActionListener(this);
		bRespostaB.setText("B");

		bRespostaC.setBounds(0, 300, 100, 100);
		bRespostaC.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		bRespostaC.setFocusable(false);
		bRespostaC.addActionListener(this);
		bRespostaC.setText("C");

		bRespostaD.setBounds(0, 400, 100, 100);
		bRespostaD.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		bRespostaD.setFocusable(false);
		bRespostaD.addActionListener(this);
		bRespostaD.setText("D");
		
		/*-------------------------------DESIGNING RESPOSTAS---------------------------------*/
		respostaA.setBounds(125, 100, 1000, 100); // SETING SIZE-BOUNDS
		respostaA.setBackground(new Color(164, 229, 224)); // SETTING BACKGROUND COLOR
		respostaA.setForeground(new Color(219, 245, 240)); // SETING FOREGROUND COLOR
		respostaA.setFont(new Font("Comic Sans MS", Font.BOLD, 20)); // SETTING FONT TYPE

		respostaB.setBounds(125, 200, 1000, 100);
		respostaB.setBackground(new Color(164, 229, 224));
		respostaB.setForeground(new Color(219, 245, 240));
		respostaB.setFont(new Font("Comic Sans MS", Font.BOLD, 20));

		respostaC.setBounds(125, 300, 1000, 100);
		respostaC.setBackground(new Color(164, 229, 224));
		respostaC.setForeground(new Color(219, 245, 240));
		respostaC.setFont(new Font("Comic Sans MS", Font.BOLD, 20));

		respostaD.setBounds(125, 400, 1000, 100);
		respostaD.setBackground(new Color(164, 229, 224));
		respostaD.setForeground(new Color(219, 245, 240));
		respostaD.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		
		/*-------------------------------------CRONOMETRO-------------------------------------*/
		cronometroSegundos.setBounds(535, 510, 100, 100);
		cronometroSegundos.setBackground(new Color(164, 229, 224));
		cronometroSegundos.setForeground(new Color(12, 97, 112));
		cronometroSegundos.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		...
		textTempo.setBackground(new Color(164, 229, 224));
		textTempo.setForeground(new Color(12, 97, 112));
		textTempo.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
